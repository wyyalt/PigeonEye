"""
Django settings for PigeonEye project.
...
SECRET_KEY = '%f(+s*ntooj_k(k($l8l(0itk=m+7__jai1f+9$6%c3aphjf)*'
...
WSGI_APPLICATION = 'PigeonEye.wsgi.application'
